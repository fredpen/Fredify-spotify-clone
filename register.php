    ...
    <div id="background">
      <div id="loginContainer">
        <div id="inputContainer">
           <form id="loginForm" action="register.php" method="POST">
            ...
            <p><?php echo $account->getError(Constants::$loginFailed) ?>
              ...
              <input type="text" value="<?php getInputValue('loginUsername') ?>" name="loginUsername" placeholder="e.g janedow401" required>
            </p>
            <p>
        ...
        <div id="logintext">
          ...
          <ul>
          <li><span>&#10003;</span> Discover music you'll fall in love with</li>
          <li><span>&#10003;</span>Create your own playlist</li>
          <li><span>&#10003;</span>Follow artists to keep up to date</li>
          </ul>
        </div>
      </div>
    </div>
